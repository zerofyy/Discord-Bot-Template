...
class Coloring:
    """ Static class for coloring and formatting text. """
    ...
    @staticmethod
    def init() -> None:
        """ Run a system call to enable colors and formats in the console. """
    ...
    def _gradient1d(input_str: str, start: tuple[int, int, int], end: tuple[int, int, int]) -> str:
        ...
        for i, char in enumerate(input_str):
            ...
            output_str += f'{Coloring.Text(r, g, b)}{char}{Coloring.Text.rs}'
    ...
    def _gradient2d(lines: list[str], start: tuple[int, int, int], end: tuple[int, int, int]) -> str:
        ...
        for line in lines:
            for char in line:
                ...
                output_str += f'{Coloring.Text(r, g, b)}{char}{Coloring.Back.rs}'
                char_count += 1
